													...
													<div class="col-md-6">
                                                         <div class="form-group">
                                                            ...
                                                            <?php
                                                             foreach($bank as $row)
            												  { ?>
            													<option value="<?php echo $row->kodeakun;?>" <?php if($sumber==$row->kodeakun) echo 'selected=true'?> ><?php echo $row->namaakun;?></option>
                                                            <?php } ?>
            												</select>
													        </div>
													...
													<div class="col-md-6">
                                                         <div class="form-group">
                                                            ...
                                                            <?php
                                                             foreach($bank as $row)
            												  { ?>
            													<option value="<?php echo $row->kodeakun;?>" <?php if($tujuan==$row->kodeakun) echo 'selected=true' ?>><?php echo $row->namaakun;?></option>
                                                            <?php } ?>
