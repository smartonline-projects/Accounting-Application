												...
												<div class="row">												    												
													...
													<div class="col-md-6">
														<div class="form-group">
													        ...
													        <div class="col-md-6">
														        <div class="input-group">
																   <input type="text" class="form-control input-medium" name="kodepu"  id="kodepu" value="<?php echo $rowh->kodepu;?>" >																																															
												 ...
												 <div class="col-md-12">
													...
													<tr>													   
                                                       ...
                                                       <td width="10%" ><input name="qty[]"   value="<?php echo $row->qtyretur;?>"  onchange="totalline(<?php echo $no;?>);total()" value="1" id="qty<?php echo $no;?>" type="text" class="form-control rightJustified"  ></td>
														...
														<td width="15%" ><input name="harga[]"  value="<?php echo $row->hargabeli;?>" onchange="totalline(<?php echo $no;?>)"  id="harga<?php echo $no;?>" type="text" class="form-control rightJustified"  ></td>
...
{	        
	...
	$.ajax({				
		url:'<?php echo site_url('pembelian_retur/save/2')?>',				
