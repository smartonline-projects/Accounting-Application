					...
					<div class="portlet">
						...
						<div class="portlet-body">
                            ...
                            <thead>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->nolpb;?>">
                                         <td align="center"><?php echo $row->nolpb;?></td>
										 <td align="center"><?php echo $row->noterima;?></td>
                                         <td align="center"><?php echo date('d-m-Y',strtotime($row->tgllpb));?></td>										 
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>pembelian_penerimaan/edit/<?php echo $row->nolpb;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
        ...
        init: function () {
            ...
            function deleteRow ( oTable, nRow)
            {
                if (confirm("Hapus Data Ini?")) {
                    ...
                    var row_id = nRow.id;
                    var mydata = row_id.substring(4,100);
