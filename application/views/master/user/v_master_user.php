    ...
    <link href="<?php echo base_url('assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css')?>" rel="stylesheet">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					  Utilitas <small>Pengguna Aplikasi</small>
					</h3>
...
function edit_data(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="uidlogin"]').val(data.uidlogin);
            $('[name="karyawan"]').val(data.username);
			$('[name="unit"]').val(data.cabang);
...
function edit_menu(id)
{
	...
	$(document).ready(function() {
		...
		var nomor= this.id;
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>master_user_grup/cetak/'+nomor+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
