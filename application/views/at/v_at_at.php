	...
	<link href="<?php echo base_url()?>assets/plugins/bootstrap-datepicker/css/datepicker.css"/>
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					  Aktiva Tetap <small>Data Aktiva Tetap</small>
					</h3>
...
function edit_data(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="hargaperolehan"]').val(data.hargaperolehan);
            $('[name="tanggalbeli"]').val(data.tanggalbeli);
...
<script>
	$(document).ready(function() {
		...
		$("#MyModalBody").html('<iframe src="<?php echo base_url();?>at_at/cetak/'+no_daftar+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama AT</label>
                            <div class="col-md-9">
						...
						<div class="form-group">
                            <label class="control-label col-md-3">Jenis Aktiva</label>
                            <div class="col-md-9">
                                <select name="jenis" class="form-control">
                                    <option value="">--Pilih Kode--</option>
									<?php 
									foreach($atjenis->result_array() as $db)
					                {
									?>
                                    <option value="<?php echo $db['kode'];?>"><?php echo $db['kode'].'-'.$db['nama'];?></option>
                                    <?php } ?>
                                </select>
                                <span class="help-block"></span>
                            </div>
						...
						<div class="form-group">
						<label class="col-md-3 control-label">Tgl Beli</label>
						<div class="col-md-4">
						   <div class="input-icon">
							<i class="fa fa-calendar"></i>
							<input id="tanggal" name="tanggalbeli" class="form-control date-picker" type="text"  data-date-format="dd-mm-yyyy" data-date-viewmode="years" placeholder=""/>
						   </div>
						</div>
					</div>
