												...
												<div class="row">	
													...
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-4">
														        <input id="tanggal" name="tanggal" class="form-control date-picker input-medium" type="date" value="<?php echo date('Y-m-d',strtotime($rowh->tglbayar));?>"/>
													...
													<div class="col-md-6">
                                                         <div class="form-group">
													        ...
													        <div class="col-md-4">
															    ...
															    <input id="tanggalcek" name="tanggalcek" class="form-control input-medium" type="date" value="<?php echo date('Y-m-d',strtotime($rowh->tglcek));?>" />
