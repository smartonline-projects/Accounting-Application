                                                         ...
                                                         <div class="form-group">
													        ...
													        <div class="col-md-4">
														       <div class="input-icon">
															    ...
															    <input id="tanggal" name="tanggal" class="form-control" type="date" value="<?php echo date('Y-m-d',strtotime($rowh->tglso));?>"  placeholder="" onkeypress="return tabE(this,event)"/>
													    	   </div>
													        </div>
												 ...
												 <div class="form-group">
													...
													<div class="col-md-4">
													   <div class="input-icon">
														...
														<input id="tanggalkirim" name="tanggalkirim" class="form-control" type="date" value="<?php echo date('Y-m-d',strtotime($rowh->tglkirim));?>"  placeholder="" onkeypress="return tabE(this,event)"/>
													   </div>
													</div>
												</div>
											</div>
...
{	            
	...
	$.ajax({				
		...
		success:function(data){ 
		  $.gritter.add({
						title: '<b><?php echo 'Penjualan';?></b>',
						text: 'Pesanan dengan nomor '+noform+' BERHASIL disimpan ',					
                        image: '<?php echo base_url('assets/img/logoi.png');?>',   						
						position: 'bottom',
		...
		error:function(data){
			...
			$.gritter.add({
						title: '<b><?php echo 'Penjualan';?></b>',
						text: 'Pesanan dengan nomor '+noform+' GAGAL disimpan, periksa kembali data yang dimasukan dan lakukan SIMPAN ulang ',					
                        image: '<?php echo base_url('assets/img/logoi.png');?>',   						
						position: 'bottom',
