					...
					<div class="portlet">
						...
						<div class="portlet-body">
                            ...
                            <thead>
                                     ...
                                     <tr class="show1" id="row_<?php echo $row->koderetur;?>">
                                         <td align="center"><?php echo $row->koderetur;?></td>
										 <td align="center"><?php echo date('d-m-Y',strtotime($row->tglretur));?></td>										 
                                         <td><?php echo $row->nama;?></td>
										 <td><?php echo $row->keterangan;?></td>
                                         <td align="right"><?php echo number_format($row->totalretur,0,'.',',');?></td>
                                         ...
                                         <td style="text-align: center">
                                            <?php
											 ...
											 <a href="<?php echo base_url()?>penjualan_retur/edit/<?php echo $row->koderetur;?>">Edit</a></td>
                                            <?php }?>
                                         </td>
                                         <td style="text-align: center">
                                           <?php
...
$(document).ready(function() {
		...
		$("#simkeureport").html('<iframe src="<?php echo base_url();?>penjualan_retur/cetak/'+param+'" frameborder="no" width="100%" height="420"></iframe>');
		});	
	});
