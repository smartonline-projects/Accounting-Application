    ...
    <!--div class="page-content-wrapper">
		<div class="page-content"-->
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					  Buku Besar <small>Akun Perkiraan</small>
					</h3>
...
function edit_data(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="jenis"]').val(data.kelompok);
            $('[name="akuninduk"]').val(data.akuninduk);
			$('[name="kodem"]').val(data.kodem);
			$('[name="kodek"]').val(data.kodek);
			$('[name="akuntx"]').val(data.tx);
